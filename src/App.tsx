  ...
  return (
    <>
      ...
      <p className="text-md">
        ...
        maestria. Colocamos nossos valores na formação de cada estudante que
        ingressa nos nossos cursos e trabalhamos exaustivamente para sermos
        motivo de orgulho para nossa gente.
      </p>
      <h1 className="font-serif text-x3l md:text-x4l lg:text-x5l">
