...
export const DEDICATION_DESCRIPTION = [
  "A Universidade Federal de Alagoas completa 60 anos. Uma história que está enraizada na vida do povo alagoano. Comemoramos esta data com a certeza de que seguimos cumprindo o nosso dever institucional de fazer a diferença para o nosso povo.",
  ...
  "Mas nossa importância ultrapassa os muros da Universidade e vai além dos profissionais que colocamos no mercado de trabalho: somos a arte fomentada pelos nossos equipamentos culturais, somos as pesquisas que dão respostas pelas quais nossa sociedade anseia, somos os projetos de extensão que alteram a realidade do nosso entorno, somos a saúde das pessoas de quem cuidamos no nosso Hospital Universitário.",
...
export const EXPOSE_DESCRIPTION = [
  ...
  "Muito dessa história foi registrada em palavras. Nos livros escritos, nas teses e dissertações, nas edições da Bienal Internacional do Livro, nos anais de uma infinidade de congressos e eventos. Por sua própria natureza, a história da Ufal era grande demais para ficar restrita à capital e foi ganhando, passo a passo, o interior, o sertão, o coração desse estado.",
  "A história da Ufal também foi escrita por esses pés que caminharam e ainda caminham. As imagens que figuram nessa exposição não são necessariamente as mais importantes ou emblemáticas, mas foram escolhidas de modo que dessem um vislumbre até mesmo nos momentos que o poeta Manoel de Barros chamaria de desimportantes e, por isso mesmo, tão especiais.",
  "Renner Boldrino",
  "Curador da Exposição Virtual Ufal 60 anos",
  "As fotos dessa exposição foram feitas, em sua grande maioria, por profissionais da Ascom que fizeram ou ainda fazem parte do quadro do setor. São eles: Manoel Correia da Mota, Edmilson da Silva Pereira, Laércio Luiz, Arlindo Tavares, Jonatas Medeiros, Renner Boldrino e Thiago Prado. Ao mencioná-los, queremos registrar nosso agradecimento a todos aqueles que, nos momentos mais diversos, deixaram registrado parte do legado da Ufal.",
];
